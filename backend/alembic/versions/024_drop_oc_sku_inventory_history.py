"""Drop oc_sku_inventory_history — stock chart reads oc_stock_movement_line only.

Revision ID: 024_drop_oc_sku_inventory_history
Revises: 023_oc_sku_inventory_history_restore
...
revision: str = "024_drop_oc_sku_inventory_history"
down_revision: Union[str, None] = "023_oc_sku_inventory_history_restore"
